...
class PhotoSplitterApp:
    def __init__(self, root):
        ...
        # Labels
        self.label_original = tk.Label(self.frame_bottom, text="Original Image")
        self.label_original.pack(side=tk.LEFT, padx=10)

        self.label_draw = tk.Label(self.frame_bottom, text="Draw Here")
        self.label_draw.pack(side=tk.RIGHT, padx=10)
        ...
        self.canvas_preview.pack(side=tk.RIGHT, padx=10)
        ...
        root.bind_all("<Control-v>", self.ctrl_v_paste)
